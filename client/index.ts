...
import { VEHICLE_STATE } from '@AthenaPlugins/athena-plugin-fuel/shared/vehicle';
...
class InternalFunctions implements ViewModel {
    ...
    static defaultFueltankComponent(propName: string) {
        ...
        if (alt.Player.local.vehicle.hasSyncedMeta(VEHICLE_STATE.FUELTANK.toString())) {
            fueltank = alt.Player.local.vehicle.getSyncedMeta(VEHICLE_STATE.FUELTANK.toString()) as number;
        }
    ...
    //    if (alt.Player.local.vehicle.hasSyncedMeta(VEHICLE_STATE.MILEAGE.toString())) {
    //        mileage = alt.Player.local.vehicle.getSyncedMeta(VEHICLE_STATE.MILEAGE.toString()) as number;
    //    }
